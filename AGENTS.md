...
- `scripts/generate-brand-assets.mjs`: regenera los favicons PNG/ICO desde `public/favicon-source.png`; `RobotMark.astro` conserva `public/favicon.svg` como símbolo vectorial del shell.
