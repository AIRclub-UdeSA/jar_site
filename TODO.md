...
- [x] **Reestructurar workshops** — Workshop 01 y 02 siguen una secuencia práctica común; sidebar y catálogo se generan desde `semana-NN-*` y consumen título, resultado, duración, nivel y estado desde el frontmatter.
...
- [ ] **Escribir el workshop de la semana 03 (SLAM y mapeo)** — `src/content/docs/workshops/semana-03-slam-mapeo.md` sigue como stub `proximamente`, sin duración ni nivel hasta publicar contenido validado. Usar `src/templates/plantilla-semana.md`; el código va al repo `jar_workshops` como en las semanas 01 y 02.
